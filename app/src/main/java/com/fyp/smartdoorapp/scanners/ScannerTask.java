...
import com.fyp.smartdoorapp.activities.ResultActivity;
import com.fyp.smartdoorapp.data.AppInfo;
...
public class ScannerTask extends AsyncTask<Void, String, Void> {
    ...
    private ArrayList<AppInfo> goodware = new ArrayList<>();
    private ArrayList<AppInfo> spyware = new ArrayList<>();
    private ArrayList<AppInfo> unknown = new ArrayList<>();
    private ArrayList<AppInfo> risky = new ArrayList<>();
            ...
            if ((packageInfo.flags & ApplicationInfo.FLAG_SYSTEM) == 1 && !withSysApps) {// checking if it is a system app.
                ...
                try {
                    ...
                    if (inferredValue > 0.75) {
                        app.prediction = contextRef.get().getString(R.string.spyware);
                        spyware.add(app);
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        Collections.sort(spyware, AppInfo.appNameComparator);
