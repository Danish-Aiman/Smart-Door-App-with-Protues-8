                        ...
                        if (!door.equals(""))
                        {
                            ...
                            handler.post(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    PutData putData = new PutData("http://192.168.50.173:80/LoginSystem/update.php", "POST", field, data);
                                    if (putData.startPut()) {
                ...
                if (!username.equals(""))
                {
                    ...
                    handler.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            PutData putData = new PutData("http://192.168.50.173:80/LoginSystem/delete.php", "POST", field, data);
                            if (putData.startPut()) {
                                if (putData.onComplete()) {
                                    String result = putData.getResult();
